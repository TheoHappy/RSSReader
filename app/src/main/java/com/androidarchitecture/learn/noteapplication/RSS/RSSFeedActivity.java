...
public class RSSFeedActivity extends ListActivity {
    ...
    com.androidarchitecture.learn.noteapplication.RSS.RSSParser rssParser = new RSSParser();
    Toolbar toolbar;

    List<com.androidarchitecture.learn.noteapplication.RSS.RSSItem> rssItems = new ArrayList<>();
